...
<div class="container px-6 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm p-6">
            <div class="mb-6">
                <h1 class="text-2xl font-bold">Nueva Encuesta</h1>
                <p class="text-neutral-500 dark:text-neutral-400">Crea una nueva encuesta para los estudiantes</p>
            </div>

            <form action="/src/plataforma/app/admin/surveys/store" method="POST" class="space-y-6">
                <!-- Información General -->
                <div class="bg-neutral-50 dark:bg-neutral-900 p-4 rounded-lg space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="title" required class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="type" required class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                                ...
                                <option value="docente">Evaluación Docente</option>
                        ...
                        <div>
                            ...
                            <input type="date" name="start_date" required class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Fecha de Fin</label>
                            <input type="date" name="end_date" required class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        <label class="flex items-center">
                            <input type="checkbox" name="is_anonymous" value="1" class="rounded border-neutral-300 dark:border-neutral-700">
                            <span class="ml-2 text-sm text-neutral-700 dark:text-neutral-300">Encuesta Anónima</span>
                        </label>
                        <label class="flex items-center">
                            <input type="checkbox" name="is_required" value="1" class="rounded border-neutral-300 dark:border-neutral-700">
                    ...
                    <div id="questions-container" class="space-y-4">
                        ...
                        <div class="question-item bg-white dark:bg-neutral-800 p-4 rounded-lg border border-neutral-200 dark:border-neutral-700">
                            <div class="flex justify-between items-start mb-4">
                                <h3 class="font-medium">Pregunta 1</h3>
                                <button type="button" class="remove-question text-red-500 hover:text-red-700" style="display: none;">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="questions[0][text]" required class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Tipo de Respuesta</label>
                                    <select name="questions[0][type]" required class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                            ...
                            <div class="options-container" style="display: none;">
                                ...
                                <div class="space-y-2">
                                    <input type="text" name="questions[0][options][]" placeholder="Opción 1" class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                                    <input type="text" name="questions[0][options][]" placeholder="Opción 2" class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                                    <input type="text" name="questions[0][options][]" placeholder="Opción 3" class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                                    <input type="text" name="questions[0][options][]" placeholder="Opción 4" class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                                </div>
                            </div>

                            <label class="flex items-center mt-2">
                                <input type="checkbox" name="questions[0][required]" value="1" class="rounded border-neutral-300 dark:border-neutral-700">
                ...
                <div class="flex justify-end gap-4">
                    <a href="/src/plataforma/app/admin/surveys" class="px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-700">
                        Cancelar
                    </a>
...
<script>
    ...
    document.getElementById('add-question').addEventListener('click', function() {
        ...
        // Show remove button
        questionItem.querySelector('.remove-question').style.display = 'block';
