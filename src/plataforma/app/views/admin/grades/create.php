    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm p-6">
            <div class="mb-6">
                ...
                <p class="text-neutral-500 dark:text-neutral-400">Ingresa una nueva calificación para un estudiante</p>
            </div>

            <form action="/src/plataforma/app/admin/grades/store" method="POST" class="space-y-6">
