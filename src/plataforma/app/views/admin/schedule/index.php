...
if (!empty($clases)) {
    foreach ($clases as $clase) {
        ...
        $clase_mapeada = [
            ...
            'dia' => $clase->day_of_week ?? null,
            'hora_inicio' => $clase->start_time ?? null,
            'hora_fin' => $clase->end_time ?? null
        ];
        if (isset($clase_mapeada['dia'], $clase_mapeada['hora_inicio'])) {
            $horario_matriz[$clase_mapeada['dia']][$clase_mapeada['hora_inicio']] = $clase_mapeada;
        }
    }
}
?>
...
<main class="p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <!-- CORREGIDO: ir a /app/admin/schedule/add (GET), no a /store -->
        <a href="/src/plataforma/app/admin/schedule/add"
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-sm border border-neutral-200 dark:border-neutral-700 <?= isset($horario_matriz[$dia][$hora]) ? 'bg-neutral-50 dark:bg-neutral-700' : '' ?>">
                                    ...
                                    ?>
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                <!-- CORREGIDO: incluir /app en la ruta de edición -->
                                                <a href="/src/plataforma/app/admin/schedule/edit/<?= (int)$clase['id'] ?>" 
