  ...
  <div class="max-w-3xl mx-auto">
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm p-6">
      <div class="mb-6">
        ...
        <p class="text-neutral-500 dark:text-neutral-400">Ingresa la información del nuevo alumno</p>
      </div>

      <form action="/admin/alumnos/store" method="POST" class="space-y-6">
            ...
            <div>
              ...
              <select name="carrera_id" required class="w-full px-4 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800">
                ...
                <?php foreach (($carreras ?? []) as $carrera): ?>
                  <option value="<?= htmlspecialchars($carrera['id'] ?? $carrera) ?>"><?= htmlspecialchars($carrera['nombre'] ?? $carrera) ?></option>
                <?php endforeach; ?>
              </select>
            </div>
            <div>
