    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm p-6">
            <div class="mb-6">
                ...
                <p class="text-neutral-500 dark:text-neutral-400">Crea una nueva encuesta para tus estudiantes</p>
            </div>

            <form action="/src/plataforma/app/teacher/surveys/store" method="POST" class="space-y-6">
                <!-- Información General -->
